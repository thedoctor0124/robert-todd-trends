<div>
    <div class="auth-card">
        ...
        <p class="text-muted small mb-4">Join to access premium trend publications.</p>
        ...
        <form wire:submit="register">
            <div class="mb-3">
                <label for="name" class="form-label small text-uppercase ls-wide">Full Name</label>
                <input type="text" class="form-control" id="name" wire:model="name" required autofocus>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label small text-uppercase ls-wide">Email</label>
                <input type="email" class="form-control" id="email" wire:model="email" required>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label small text-uppercase ls-wide">Password</label>
                <input type="password" class="form-control" id="password" wire:model="password" required>
            </div>
            <div class="mb-4">
                <label for="password_confirmation" class="form-label small text-uppercase ls-wide">Confirm Password</label>
