...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Local disk for Livewire chunks; permanent files use App\Support\ContentDisk (public or GCS).
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'local'),
        'rules' => ['required', 'file', 'max:102400'],         // 100MB max for PDF uploads
    ...
    */
    ...
    'payload' => [
        'max_size' => 12 * 1024 * 1024,   // 12MB — avoid clipping Livewire updates with file metadata
